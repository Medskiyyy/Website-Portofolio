          ...
          {contactMethods.map((method, idx) => (
            <Reveal key={method.label} delay={0.1 + idx * 0.1} className="h-full">
              <a
                ...
                className="group surface-card block h-full rounded-2xl bg-card/90 backdrop-blur-xs p-6 transition-colors duration-200 hover:border-primary/50 sm:p-8 active:scale-[0.985]"
              >
