    ...
    <main className="relative overflow-hidden border-b border-border/60 bg-transparent py-24 md:py-32">
      ...
      <div className="section-shell relative">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="space-y-8">
            <Reveal delay={0.15}>
              <AboutSection title={t("backgroundTitle")}>
                <p className="text-base leading-relaxed text-muted-foreground">{t("backgroundText")}</p>
              </AboutSection>
            </Reveal>

            <Reveal delay={0.25}>
              <AboutSection title={t("philosophyTitle")}>
                <p className="text-base leading-relaxed text-muted-foreground mb-6">{t("philosophyText")}</p>
                <div className="grid grid-cols-1 gap-3">
                  {principles.map((p) => (
                    ...
                    >
                      <p className="font-heading font-bold text-foreground text-base mb-1">{p.title}</p>
          ...
          <div className="space-y-8">
            <Reveal delay={0.2}>
              <AboutSection title={t("workflowTitle")}>
                <p className="text-base leading-relaxed text-muted-foreground mb-6">{t("workflowText")}</p>
            ...
            <Reveal delay={0.3}>
              <AboutSection title={t("goalsTitle")}>
                <p className="text-base leading-relaxed text-muted-foreground">{t("goalsText")}</p>
              </AboutSection>
            </Reveal>
          </div>
        </div>
